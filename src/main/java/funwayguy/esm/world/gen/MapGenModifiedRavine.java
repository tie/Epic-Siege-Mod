...
public class MapGenModifiedRavine extends MapGenBase
{
	...
	public void func_151539_a(IChunkProvider chunkProviderCaves, World worldObj, long seed, int chunkX, int chunkY, Block[] ablock)
	{
        int k = this.range;
	...
	private boolean isExceptionBiome(BiomeGenBase biome)
	{
		...
		if (biome == BiomeGenBase.hell) return true;
		return false;
	}
