...
import funwayguy.esm.world.gen.MapGenModifiedCaves;
import funwayguy.esm.world.gen.MapGenModifiedRavine;
...
public class ChunkProviderNewHell implements IChunkProvider
{
	...
	public ChunkProviderNewHell(World p_i2005_1_, long p_i2005_2_)
	{
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
	{
        ...
        for (k1 = 0; doGen && k1 < 16; ++k1)
        {
            ...
            i2 = this.hellRNG.nextInt(236) + 10;
