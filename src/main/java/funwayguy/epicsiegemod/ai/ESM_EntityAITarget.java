...
public abstract class ESM_EntityAITarget extends EntityAIBase
{
    ...
    public boolean continueExecuting()
    {
        ...
        if (entitylivingbase == null && this.field_188509_g != null)
        {
    ...
    protected boolean isSuitableTarget(EntityLivingBase target, boolean includeInvincibles)
    {
        ...
        else if (taskOwner instanceof EntityCreature && !((EntityCreature)this.taskOwner).isWithinHomeDistanceFromPosition(new BlockPos(target)))
        {
            return false;
        }
        else
